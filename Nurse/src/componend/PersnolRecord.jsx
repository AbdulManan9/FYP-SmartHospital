...
const PersnolRecord = (props) => {
    ...
    const fetchList = async () => {
        try {
            const response = await axios.get( `http://localhost:4000/api/nurse/persnolDetail/${patient_id}`);
            ...
            if (response.data.success === true) {
                ...
                setPatientList(response.data.data); // Assuming it's a single patient object
            } else {
